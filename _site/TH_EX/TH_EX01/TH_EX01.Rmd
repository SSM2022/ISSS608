...
[**subset()**](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/subset) returns subsets of vectors, matrices or data frames which meet conditions. We use this method to split population data by gender, so that we can plot male data on the negative side and female data on the positive side.
...
+ [**scale_y_continuous**](https://ggplot2.tidyverse.org/reference/scale_continuous.html) allows us to cumtomize breaks and labels. Breaks are set between -160,000 to 160,000 with 20,000 interval. Labels are set as character and use "K" to represent 1,000. 
